...
const contentMap: Record<string, any> = {
  ...
  influencers: {
    ...
    icon: <Target size={32} className="text-green" />,
    features: [
  ...
  careers: {
    ...
    icon: <Briefcase size={32} className="text-green" />,
    features: [
  ...
  academy: {
    ...
    icon: <GraduationCap size={32} className="text-green" />,
    features: [
      ...
      <div className="max-w-4xl mx-auto px-6 w-full">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <div className="w-20 h-20 bg-green-lt rounded-2xl flex items-center justify-center mb-8 border border-green/10">
              {content.icon}
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-ink tracking-tight leading-[1.1] mb-6">
              {content.title}
            </h1>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12 w-full max-w-2xl text-left">
              {content.features.map((feature: string, i: number) => (
                <div key={i} className="flex items-center gap-3 bg-cream/50 p-4 rounded-lg border border-bdr-d">
                  <div className="w-6 h-6 rounded-full bg-green-lt flex items-center justify-center shrink-0">
